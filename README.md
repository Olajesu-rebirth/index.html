...
<body>
  ...
  <main>
    ...
    <section>
      <h2>Skills</h2>
      <ul>
        <li>Power Systems Studies & Stability (Small-signal, Voltage, and Transient)</li>
        <li>Renewable Energy Systems</li>
        <li>Smart Grid</li>
        <li>Robotics, Research and Development (R&D), Internet of Things (IoT)</li>
        <li>PSS/E</li>
        <li>Python, C, Git,</li>
        <li>Data Analysis</li>
      </ul>
...
<body>
  ...
  <main>
    ...
    <section class="contact-info">
      ...
      <p>Email: adeleke.j.olaoluwa@gmail.com</p>
      <p>LinkedIn: <a href="https://www.linkedin.com/in/olaoluwaadeleke" target="_blank">olaoluwaadeleke</a></p>
      <p>GitHub: <a href="https://github.com/Olajesu-rebirth" target="_blank">olaoluwaadeleke</a></p>
...
" target="_blank">olaoluwaadeleke</a></p>
      <p>ResearchGate: <a href="https://www.researchgate.net/profile/Olaoluwa-Adeleke-3?ev=hdr_xprf" target="_blank">Olaoluwa Adeleke</a></p>
    </section>
  </main>
